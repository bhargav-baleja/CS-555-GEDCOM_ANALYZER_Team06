"""
Author: Ananya, Bhargav, Irfan
Team: 06
Project: 03
Description: This program get the data from a gedcom file and
then list the individuals and families with unique id.
"""
...
class Individual:
    ...
    """
    PT_FIELD_NAMES = ['Id', 'Name', 'Gender', 'Birthday', 'Age', 'Alive', 'Death', 'Child', 'Spouse']
